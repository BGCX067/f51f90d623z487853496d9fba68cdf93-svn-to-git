...
/**
 * Base class that represents a row from the 'grupo_trabajo_sc' table.
 *
 * 
 *
 ...
 */
abstract class BaseGrupoTrabajoSc extends BaseObject  implements Persistent {
	 ...
	 */
	protected $collTreeScs;

	/**
	 * @var        Criteria The criteria used to select the current contents of collTreeScs.
	 */
	private $lastTreeScCriteria = null;
	 ...
	 * @return     GrupoTrabajoSc The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = GrupoTrabajoScPeer::ID;
		}
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = GrupoTrabajoScPeer::NAME;
		}
	...
	public function setOwnerId($v)
	{
		...
		if ($this->owner_id !== $v) {
			$this->owner_id = $v;
			$this->modifiedColumns[] = GrupoTrabajoScPeer::OWNER_ID;
		}
	...
	public function setFlag($v)
	{
		...
		if ($this->flag !== $v) {
			$this->flag = $v;
			$this->modifiedColumns[] = GrupoTrabajoScPeer::FLAG;
		}
	...
	public function setCreateAt($v)
	{
		...
		if ( $this->create_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = GrupoTrabajoScPeer::CREATE_AT;
			}
	...
	public function setUpdateAt($v)
	{
		...
		if ( $this->update_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = GrupoTrabajoScPeer::UPDATE_AT;
			}
		} // if either are not null
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->flag = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			$this->create_at = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
			...
			return $startcol + 6; // 6 = GrupoTrabajoScPeer::NUM_COLUMNS - GrupoTrabajoScPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating GrupoTrabajoSc object", $e);
		}
	}
	...
	public function ensureConsistency()
	{
		...
		if ($this->aUserSc !== null && $this->owner_id !== $this->aUserSc->getId()) {
			$this->aUserSc = null;
		}
	} // ensureConsistency
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = GrupoTrabajoScPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
		...
		if ($deep) {  // also de-associate any related objects?
			...
			$this->aUserSc = null;
			$this->collTreeScs = null;
			$this->lastTreeScCriteria = null;
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BaseGrupoTrabajoSc:delete:pre') as $callable)
			{
			...
			if ($ret) {
				GrupoTrabajoScPeer::doDelete($this, $con);
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseGrupoTrabajoSc:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseGrupoTrabajoSc:save:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseGrupoTrabajoSc:save:post') as $callable)
				{
				  call_user_func($callable, $this, $con, $affectedRows);
				}

				GrupoTrabajoScPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = GrupoTrabajoScPeer::doInsert($this, $con);
					...
					$affectedRows += GrupoTrabajoScPeer::doUpdate($this, $con);
				}
			...
			if ($this->collTreeScs !== null) {
				foreach ($this->collTreeScs as $referrerFK) {
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = GrupoTrabajoScPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = GrupoTrabajoScPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = GrupoTrabajoScPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getName(),
			$keys[2] => $this->getOwnerId(),
			$keys[3] => $this->getFlag(),
			$keys[4] => $this->getCreateAt(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[4], $arr)) $this->setCreateAt($arr[$keys[4]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(GrupoTrabajoScPeer::ID)) $criteria->add(GrupoTrabajoScPeer::ID, $this->id);
		if ($this->isColumnModified(GrupoTrabajoScPeer::NAME)) $criteria->add(GrupoTrabajoScPeer::NAME, $this->name);
		if ($this->isColumnModified(GrupoTrabajoScPeer::OWNER_ID)) $criteria->add(GrupoTrabajoScPeer::OWNER_ID, $this->owner_id);
		if ($this->isColumnModified(GrupoTrabajoScPeer::FLAG)) $criteria->add(GrupoTrabajoScPeer::FLAG, $this->flag);
		if ($this->isColumnModified(GrupoTrabajoScPeer::CREATE_AT)) $criteria->add(GrupoTrabajoScPeer::CREATE_AT, $this->create_at);
		if ($this->isColumnModified(GrupoTrabajoScPeer::UPDATE_AT)) $criteria->add(GrupoTrabajoScPeer::UPDATE_AT, $this->update_at);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(GrupoTrabajoScPeer::ID, $this->id);
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     GrupoTrabajoSc Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     GrupoTrabajoScPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new GrupoTrabajoScPeer();
		}
		return self::$peer;
	}
	...
	{
		if ($this->aUserSc === null && ($this->owner_id !== null)) {
			$this->aUserSc = UserScPeer::retrieveByPk($this->owner_id);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aUserSc->addGrupoTrabajoScs($this);
			 */
		}
		return $this->aUserSc;
	}
	...
	/**
	 * Clears out the collTreeScs collection (array).
	 *
	 ...
	 * @see        addTreeScs()
	 */
	public function clearTreeScs()
	{
		$this->collTreeScs = null; // important to set this to NULL since that means it is uninitialized
	}

	/**
	 * Initializes the collTreeScs collection (array).
	 *
	 * By default this just sets the collTreeScs collection to an empty array (like clearcollTreeScs());
	 * however, you may wish to override this method in your stub class to provide setting appropriate
	 * to your application -- for example, setting the initial array to the values stored in database.
	 *
	 * @return     void
	 */
	public function initTreeScs()
	{
	 ...
	 * Otherwise if this GrupoTrabajoSc has previously been saved, it will retrieve
	 * related TreeScs from storage. If this GrupoTrabajoSc is new, it will return
		...
		if ($this->collTreeScs === null) {
			if ($this->isNew()) {
			   $this->collTreeScs = array();
				...
				$criteria->add(TreeScPeer::GRUPO_TRABAJO_ID, $this->id);
	 ...
	 * @throws     PropelException
	 */
	public function addTreeSc(TreeSc $l)
	{
		if ($this->collTreeScs === null) {
			$this->initTreeScs();
		}
		if (!in_array($l, $this->collTreeScs, true)) { // only add it if the **same** object is not already associated
			array_push($this->collTreeScs, $l);
			$l->setGrupoTrabajoSc($this);
		}
	}
	 ...
	 * Otherwise if this GrupoTrabajoSc is new, it will return
	 * an empty collection; or if this GrupoTrabajoSc has previously
	 * been saved, it will retrieve related TreeScs from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in GrupoTrabajoSc.
	 */
	public function getTreeScsJoinUserScRelatedByUserId($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(GrupoTrabajoScPeer::DATABASE_NAME);
		}
		...
		if ($this->collTreeScs === null) {
			if ($this->isNew()) {
				...
				$this->collTreeScs = TreeScPeer::doSelectJoinUserScRelatedByUserId($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * actually need in GrupoTrabajoSc.
	 */
	public function getTreeScsJoinPeriodoSc($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(GrupoTrabajoScPeer::DATABASE_NAME);
		}
		...
		if ($this->collTreeScs === null) {
			if ($this->isNew()) {
				...
				$this->collTreeScs = TreeScPeer::doSelectJoinPeriodoSc($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this GrupoTrabajoSc has previously been saved, it will retrieve
	 * related DetalleGrupoTrabajoScs from storage. If this GrupoTrabajoSc is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collDetalleGrupoTrabajoScs === null) {
			if ($this->isNew()) {
			   $this->collDetalleGrupoTrabajoScs = array();
				...
				$criteria->add(DetalleGrupoTrabajoScPeer::GRUPO_ID, $this->id);
	 ...
	 * actually need in GrupoTrabajoSc.
	 */
	public function getDetalleGrupoTrabajoScsJoinUserSc($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(GrupoTrabajoScPeer::DATABASE_NAME);
		}
		...
		if ($this->collDetalleGrupoTrabajoScs === null) {
			if ($this->isNew()) {
				...
				$this->collDetalleGrupoTrabajoScs = DetalleGrupoTrabajoScPeer::doSelectJoinUserSc($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this GrupoTrabajoSc has previously been saved, it will retrieve
	 * related SolicitudGrupoTrabajoScs from storage. If this GrupoTrabajoSc is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collSolicitudGrupoTrabajoScs === null) {
			if ($this->isNew()) {
			   $this->collSolicitudGrupoTrabajoScs = array();
				...
				$criteria->add(SolicitudGrupoTrabajoScPeer::GRUPO_ID, $this->id);
	 ...
	 * actually need in GrupoTrabajoSc.
	 */
	public function getSolicitudGrupoTrabajoScsJoinUserSc($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(GrupoTrabajoScPeer::DATABASE_NAME);
		}
		...
		if ($this->collSolicitudGrupoTrabajoScs === null) {
			if ($this->isNew()) {
				...
				$this->collSolicitudGrupoTrabajoScs = SolicitudGrupoTrabajoScPeer::doSelectJoinUserSc($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this GrupoTrabajoSc has previously been saved, it will retrieve
	 * related AsignacionScs from storage. If this GrupoTrabajoSc is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collAsignacionScs === null) {
			if ($this->isNew()) {
			   $this->collAsignacionScs = array();
				...
				$criteria->add(AsignacionScPeer::GRUPO_ID, $this->id);
	...
	public function clearAllReferences($deep = false)
	{
		if ($deep) {
			if ($this->collTreeScs) {
				foreach ((array) $this->collTreeScs as $o) {
	...
	{
	  if (!$callable = sfMixer::getCallable('BaseGrupoTrabajoSc:'.$method))
	  {
	    throw new sfException(sprintf('Call to undefined method BaseGrupoTrabajoSc::%s', $method));
	  }

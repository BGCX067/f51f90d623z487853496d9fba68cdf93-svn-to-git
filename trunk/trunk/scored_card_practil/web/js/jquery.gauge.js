...
(function($) {
  ...
  $.fn.gauge = function(options) {
    ...
    return this.each(function(index, item) {
      ...
      var $foreground = $('<img alt="" src="../images/' + defaults.foregroundImage + '"/>');
      var $background = $('<img alt="" src="../images/' + defaults.backgroundImage + '"/>');
      var $pointer = $('<img alt="" src="../images/' + defaults.pointerImage + '"/>');

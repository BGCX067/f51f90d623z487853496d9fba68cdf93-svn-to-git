...
INSERT INTO `data_indicadores` (`id`,`indicador_id`,`user_id`,`data`,`group_data`,`create_at`,`update_at`) VALUES
 ...
 (25,23,3,60,7,'2011-12-22 16:54:29','2011-11-22 16:54:29'),
...
CREATE TABLE `tmp_data_reports` (
  ...
  `conectores_configure` text,
  `indicador_id` int(10) unsigned NOT NULL DEFAULT '0',
...
INSERT INTO `tmp_data_reports` (`id`,`valor_minimo`,`valor_deseado`,`valor_optimo`,`tree_id`,`previous_id`,`parents`,`indicadores_hijos_configure`,`ultimo_nodo`,`data`,`conectores_configure`,`indicador_id`,`update_at`,`flag`) VALUES
 (71,10,20,100,11,0,NULL,NULL,'',12,NULL,20,'2011-11-21 22:48:46','ok'),
 (72,10,80,100,11,71,'p71s-',NULL,'',10,'80',21,'2011-11-21 22:48:46','ok'),
 (73,50,100,200,11,71,'p71s-',NULL,'',41,'20',22,'2011-11-21 22:48:46','ok'),
 (74,150,300,450,11,72,'p71s-p72s-',NULL,'1',100,'80',23,'2011-11-21 22:48:46','ok'),
 (75,100,200,400,11,72,'p71s-p72s-',NULL,'1',200,'20',24,'2011-11-21 22:48:46','ok'),
 (76,10,200,600,11,73,'p71s-p73s-',NULL,'1',300,'50',25,'2011-11-21 22:48:46','ok'),
 (77,10,50,300,11,73,'p71s-p73s-',NULL,'1',100,'50',26,'2011-11-21 22:48:46','ok'),
 (78,10,20,100,12,0,NULL,NULL,'',1,NULL,20,'2011-11-22 16:54:29','ok'),
 (79,10,80,100,12,78,'p78s-',NULL,'',0,'80',21,'2011-11-22 16:54:29','ok'),
 (80,50,100,200,12,78,'p78s-',NULL,'',14,'20',22,'2011-11-22 16:54:29','ok'),
 (81,150,300,450,12,79,'p78s-p79s-',NULL,'1',60,'80',23,'2011-11-22 16:54:29','ok'),
 (82,100,200,400,12,79,'p78s-p79s-',NULL,'1',20,'20',24,'2011-11-22 16:54:29','ok'),
 (83,10,200,600,12,80,'p78s-p80s-',NULL,'1',30,'50',25,'2011-11-22 16:54:29','ok'),
 (84,10,50,300,12,80,'p78s-p80s-',NULL,'1',70,'50',26,'2011-11-22 16:54:29','ok');
...
INSERT INTO `tmp_tree_sc` (`id`,`valor_minimo`,`valor_deseado`,`configure_flag`,`flag`) VALUES
 (11,NULL,NULL,'','ok'),
 (12,NULL,NULL,'','ok');

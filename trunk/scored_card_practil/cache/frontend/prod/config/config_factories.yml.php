...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => 'C:\\wamp\\www\\score_card_practil\\trunk\\scored_card_practil\\log/frontend_prod.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => 'C:\\wamp\\www\\score_card_practil\\trunk\\scored_card_practil\\cache\\frontend\\prod\\i18n',
  'lifetime' => 31556926,
  'prefix' => 'C:\\wamp\\www\\score_card_practil\\trunk\\scored_card_practil\\apps\\frontend/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => 'C:\\wamp\\www\\score_card_practil\\trunk\\scored_card_practil\\cache\\frontend\\prod\\template',
  'lifetime' => 86400,
  'prefix' => 'C:\\wamp\\www\\score_card_practil\\trunk\\scored_card_practil\\apps\\frontend/template',
)));
...
$this->setMailerConfiguration(array_merge(array('class' => sfConfig::get('sf_factory_mailer', 'sfMailer')), sfConfig::get('sf_factory_mailer_parameters', array (
  ...
  array (
    ...
    'param' => 
    array (
      'host' => 'webmail.aceptor.com',
      'port' => 25,
      'encryption' => NULL,
      'username' => 'no-reply@aceptor.com',
      'password' => 'ea%G-w$h]b=7',
    ),
  ),
))));
